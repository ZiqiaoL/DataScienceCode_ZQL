...
tweets_sanders <- searchTwitter('@BernieSanders', n=100)
tweets_clinton <- searchTwitter('@HillaryClinton', n=100)
tweets_cruz <- searchTwitter('@tedcruz', n=100)
...
yay <- scan('~/Downloads/opinion-lexicon-English/positive-words.txt',
            what='character', comment.char=';')
boo <- scan('~/Downloads/opinion-lexicon-English/negative-words.txt',
            what='character', comment.char=';')
